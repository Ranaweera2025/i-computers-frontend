        ...
        <div className="w-full h-full flex flex-col items-center p-4 overflow-y-scroll">
            <div className="sticky top-0 w-full h-[100px] rounded-lg bg-accent text-white flex items-center p-5 justify-between shadow-2xl">
                ...
                <div className="h-full  flex justify-center items-center">
                    <button disabled={isSaving} onClick={handleSave} className="px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 disabled:opacity-50">Save</button>
            ...
            <div className="w-full flex flex-wrap bg-white shadow-2xl p-5 mt-8 rounded-lg">
                ...
                <div className="w-1/4   p-2">
                    ...
                    <input type="number" min="0" step="0.01" className="border border-gray-300 rounded-md p-2 w-full"
                        value={price}
                ...
                <div className="w-1/4   p-2">
                    ...
                    <input type="number" min="0" className="border border-gray-300 rounded-md p-2 w-full"
                        value={stock}
